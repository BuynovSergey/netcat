...
class nc_messaging_sms_service_unisender extends nc_messaging_sms_service implements nc_messaging_api_multi_messaging {
    ...
    public function __construct(nc_messaging_service_record $service_record) {
        parent::__construct($service_record, new nc_messaging_sms_api_unisender());
    }
